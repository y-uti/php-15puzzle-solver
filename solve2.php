...
function optimalSolver($board, $numbers, $data, $encRow, $goalFun, $ignoreOrder = false)
{
    ...
    while (!$goalFun($encnum = encode($board, $numbers, $encRow, $ignoreOrder))) {
        ...
        list($n, $board) = move($x, $y, $dirs[$i][0], $dirs[$i][1], $board);
        $result[] = $n;
    }
